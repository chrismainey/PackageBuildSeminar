...
[chris.mainey@uhb.nhs.uk](mailto:chris.mainey@uhb.nhs.uk) `r icon::fontawesome("envelope")` 

[HED.nhs.uk](https://www.hed.nhs.uk) `r icon::fontawesome("globe")` 

[mainard.co.uk](https://www.mainard.co.uk) `r icon::fontawesome("globe")` 

[github.com/chrismainey](https://github.com/chrismainey) `r icon::fontawesome("github")` 

[twitter.com/chrismainey](https://twitter.com/chrismainey) `r icon::fontawesome("twitter")` 
